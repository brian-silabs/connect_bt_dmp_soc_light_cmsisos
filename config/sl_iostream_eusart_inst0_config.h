...
#ifndef SL_IOSTREAM_EUSART_INST0_CONFIG_H
#define SL_IOSTREAM_EUSART_INST0_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>EUART settings

// <q SL_IOSTREAM_EUSART_INST0_ENABLE_HIGH_FREQUENCY> Enable High frequency mode
// <i> Default: 1
#define SL_IOSTREAM_EUSART_INST0_ENABLE_HIGH_FREQUENCY        1

// <o SL_IOSTREAM_EUSART_INST0_BAUDRATE> Baud rate
// <i> Default: 115200
...
// <i> Default: 32
#define SL_IOSTREAM_EUSART_INST0_RX_BUFFER_SIZE    32

// <q SL_IOSTREAM_EUSART_INST0_CONVERT_BY_DEFAULT_LF_TO_CRLF> Convert \n to \r\n
// <i> It can be changed at runtime using the C API.
// <i> Default: 0
#define SL_IOSTREAM_EUSART_INST0_CONVERT_BY_DEFAULT_LF_TO_CRLF     0
...
#warning "IO Stream EUSART peripheral not configured"
 ...
 #define SL_IOSTREAM_EUSART_INST0_CTS_PIN         12

 #define SL_IOSTREAM_EUSART_INST0_RTS_PORT        gpioPortC
 #define SL_IOSTREAM_EUSART_INST0_RTS_PIN         8
// [EUSART_SL_IOSTREAM_EUSART_INST0]$
// <<< sl:end pin_tool >>>
